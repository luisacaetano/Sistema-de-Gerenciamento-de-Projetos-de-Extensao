...
<!--Cabeçalho --> 
	...
	<div class="container">
		<section class="jumbotron">
			...
			<br>
			<p style="text-align: justify; font-family: Verdana; ">&nbsp; &nbsp; &nbsp; Abaixo você encontra todos os documentos referentes aos Cursos de Formação Inicial e Continuada (FIC). Em caso de dúvidas, contate o setor de Extensão do Campus Formiga.
			<br><br>
			<b>1. </b> O Formulário do <a href="projPedagogico.php" target="_blank">Projeto Pedagógico de Curso Simplificado</a> deverá ser preenchido e enviado à Extensão para início do processo quando a carga horária for menor que 160 horas. <br>
			<b>2. </b> O Formulário do <a href="projPedagogico2.php" target="_blank">Projeto Pedagógico de Curso</a> deverá ser preenchido e enviado à Extensão para início do processo quando a carga horária for maior ou igual a 160 horas. <br>
			<b>3. </b> A <a href="./documentos/ListaPresencaCurso.pdf" target="_blank">Lista de Presença</a> deverá ser assinada por todos os alunos que participarem do Curso de Formação Inicial e Continuada.<br>
			<b>4. </b> A <a href="./documentos/ListaPresencaMultiplosDias.pdf" target="_blank">Lista de Presença de Múltiplos Dias</a> deverá ser assinada por todos os alunos que participarem do Curso de Formação Inicial e Continuada nos dias solicitados. <br>
			<b>5. </b> O <a href="relacaoConcluintes.php" target="_blank">Relatório de Concluintes</a> e a <a href="./documentos/RelacaoConcluintes.pdf" target="_blank">Relação de Concluintes</a> deverão ser preenchido para entrega do certificado dos alunos que concluiram o Curso/Evento de Extensão.<br>
			<div class="row"> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
				<div class="card mb-4 shadow-sm" style="width: 20rem;">
				  	...
				  	<div class="card-body">
				    	...
				    	<a href="http://localhost/ProjExtensao/documentos/ListaPresencaCurso.pdf" class="btn btn-login" target="_blank" style="float: right; color: white">Vizualizar</a>
				  	</div>
				</div> &nbsp; &nbsp;
				<div class="card mb-4 shadow-sm" style="width: 20rem;">
				...
				<div class="card mb-4 shadow-sm" style="width: 20rem;">
				  	...
				  	<div class="card-body">
				    	...
				    	<br><br><br>
				    	<a href="http://localhost/ProjExtensao/documentos/RelacaoConcluintes.pdf" class="btn btn-login" target="_blank" style="float: right; color: white">Vizualizar</a>
				  	</div>
				</div> &nbsp; &nbsp; 	  
			</div>
		</section>
