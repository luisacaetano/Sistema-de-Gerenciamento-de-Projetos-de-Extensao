...
<!--Cabeçalho --> 
		...
		<nav class="menu navbar-expand-md bg-azul-principal menu-fixed"> 
			...
			<div class="posicionamento-menu" id="navbarCollapse">
				<ul class="alinhamento-usuario navbar-nav">
					...
					<li>
						<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" style="color: #fff"> Alterar </a>
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a href="propagandas.php" class="dropdown-item"> Propagandas </a>
						</div>
					</li>
					<li>
	...
	<div class="input-group bg-light pl-4 pt-3 pb-3" id="barraInformacaoTopo">
		<div>
			<div class="text-muted">
				<article> Administrador: Alterar Cartazes </article>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<section class="jumbotron">
			<h1 style="text-align: center; font-family: Verdana;"><b> Cartazes </b> </h1>
			<br>
			<div class="row">
