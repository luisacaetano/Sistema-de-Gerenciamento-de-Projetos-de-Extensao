	...
	<div class="input-group bg-light pl-4 pt-3 pb-3" id="barraInformacaoTopo">
		<div>
			<div class="text-muted">
				<article> Projeto Pedagógico de Curso </article>
			</div>
		</div>
	</div>
				...
				<div class="card">
					<div class="card-body">
						...
						<div class="row">
							...
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									<label for="inputEmail" style="font-family: Verdana;">Eixo Tecnológico</label>
						...
						<div class="row">
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									<label for="inputSenha" style="font-family: Verdana;">Classificação </label>
									<select class="form-control" data-size="5" data-live-search="true" data-width="100%" required="">
										<option selected=""> Selecione </option>
											<option>Formação Inicial</option>
							...
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									<label for="inputSenha" style="font-family: Verdana;">Número de Vagas por Turma </label>
						...
						<div class="row">
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									<label for="inputSenha" style="font-family: Verdana;">Frequência da Oferta do Curso </label>
									<input type="text" name="programa" class="form-control">
								</div>
							</div>
							<div class="col-md-6 col-xs-6">
						...
						<div class="row">
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									<label for="inputConfirme" style="font-family: Verdana;">Carga-Horária</label>
									<input type="number" name="programa" class="form-control">
								</div>
							</div>
							<div class="col-md-6 col-xs-6">
						...
						<div class="row">
							<div class="col-md-12 col-xs-12">
								<div class="form-group">
									<label for="inputResp" style="font-family: Verdana;"> Perfil Profissional de Conclusão</label>
									<button type="button" class="btn btn-secondary" data-toggle="tooltip" data-placement="right" title="Descreva o perfil profissional que se espera dos concluintes, abordando as capacidades esperadas" style="margin: 5px; color: white; padding: 1px; height: 20px; width: 20px; border-radius: 30px; font-family: Verdana; text-align: centers; font-size: smaller;">
									 	?
									</button>
									<textarea class="form-control" rows="2"></textarea>
								</div>
						...
						<div class="row">
							<div class="col-md-12 col-xs-12">
								<div class="form-group">
									<label for="inputResp" style="font-family: Verdana;"> Possíveis Áreas de Atuação</label>
									<button type="button" class="btn btn-secondary" data-toggle="tooltip" data-placement="right" title="Cite as prováveis áreas de atuação. Para as profissões regulamentadas, cite o perfil profissional indicado pelo órgão de regulamentação e/ou pela CBO e enumerar as possíveis áreas de atuação." style="margin: 5px; color: white; padding: 1px; height: 20px; width: 20px; border-radius: 30px; font-family: Verdana; text-align: centers; font-size: smaller;">
									 	?
									</button>
									<textarea class="form-control" rows="2"></textarea>
								</div>
						...
						<div class="row">
							<div class="col-md-12 col-xs-12">
								<div class="form-group">
									<label for="inputResp" style="font-family: Verdana;"> Diferenciais do Curso</label>
									<button type="button" class="btn btn-secondary" data-toggle="tooltip" data-placement="right" title="Explicite quais são os diferenciais do curso proposto no que se refere à organização curricular, proposta didático-metodológica, avaliação, recursos disponíveis e possibilidades do curso prever e considerar demandas profissionais futuras na localidade" style="margin: 5px; color: white; padding: 1px; height: 20px; width: 20px; border-radius: 30px; font-family: Verdana; text-align: centers; font-size: smaller;">
									 	?
									</button>
									<textarea class="form-control" rows="3"></textarea>
								</div>
						...
						<div class="row">
							<div class="col-md-12 col-xs-12">
								<div class="form-group">
									<label for="inputResp" style="font-family: Verdana;"> Matriz Curricular</label>
									<button type="button" class="btn btn-secondary" data-toggle="tooltip" data-placement="right" title="Detalhar o nome dos componentes curriculares (disciplina, módulo temático, itinerário formativo ou outra organização proposta), sua respectiva ementa e carga horária. Para cursos FIC que se relacionam com algum curso técnico do campus, na matriz curricular deve ser mencionada a possibilidade dos componentes curriculares do curso FIC serem aproveitados para fins de dispensa de disciplinas de cursos técnicos. Nesse caso, deve também ser listada a relação dos componentes que poderão ser utilizados futuramente." style="margin: 5px; color: white; padding: 1px; height: 20px; width: 20px; border-radius: 30px; font-family: Verdana; text-align: centers; font-size: smaller;">
									 	?
									</button>
						...
						<div class="row">
							<div class="col-md-12 col-xs-12">
								<div class="form-group">
									<label for="inputResp" style="font-family: Verdana;"> Relação de Docentes e Técnico-Administrativos Envolvidos com o Curso</label>
									<button type="button" class="btn btn-secondary" data-toggle="tooltip" data-placement="right" title="Liste os docentes que atuarão no curso com sua respectiva titulação. Liste os técnico-administrativos envolvidos no curso." style="margin: 5px; color: white; padding: 1px; height: 20px; width: 20px; border-radius: 30px; font-family: Verdana; text-align: centers; font-size: smaller;">
									 	?
									</button>
									<textarea class="form-control" rows="2"></textarea>
								</div>
						...
						<div class="row">
							<div class="col-md-12 col-xs-12">
								<div class="form-group">
									<label for="inputResp" style="font-family: Verdana;"> Descrição de Mecanismos que Possam Permitir a Permanência, o Êxito e a Continuidade de Estudos do Discente</label>
									<button type="button" class="btn btn-secondary" data-toggle="tooltip" data-placement="right" title="Descreva os mecanismos de assistência estudantil (auxílio transporte, auxílio alimentação, auxílio moradia, entre outros) que poderão ser utilizados pelos alunos. Descreva os mecanismos de recuperação paralela para alunos com dificuldades de aprendizagem. Descreva os mecanismos que poderão contribuir para a continuidade de estudos dos alunos em outros níveis (realização de mostras de profissão, atividades de orientação profissional, visitas técnicas)" style="margin: 5px; color: white; padding: 1px; height: 20px; width: 20px; border-radius: 30px; font-family: Verdana; text-align: centers; font-size: smaller;">
									 	?
									</button>
									<textarea class="form-control" rows="3"></textarea>
								</div>
						...
						<div class="row">
							<div class="col-md-12 col-xs-12">
								<div class="form-group">
									<label for="inputResp" style="font-family: Verdana;"> Bibliografia Indicada por Componente Curricular</label>
									<button type="button" class="btn btn-secondary" data-toggle="tooltip" data-placement="right" title="Listar a bibliografia que será utilizada no curso de acordo com as normas da ABNT" style="margin: 5px; color: white; padding: 1px; height: 20px; width: 20px; border-radius: 30px; font-family: Verdana; text-align: centers; font-size: smaller;">
									 	?
									</button>
									<textarea class="form-control" rows="3"></textarea>
								</div>
						...
						<div class="row">
							<div class="col-md-12 col-xs-12">
								<div class="form-group">
									<label for="inputResp" style="font-family: Verdana;"> Descrição do Tipo de Certificado Conferido ao Formando</label>
									<button type="button" class="btn btn-secondary" data-toggle="tooltip" data-placement="right" title="Explicite se o curso é de formação inicial ou formação continuada e a qualificação conferida" style="margin: 5px; color: white; padding: 1px; height: 20px; width: 20px; border-radius: 30px; font-family: Verdana; text-align: centers; font-size: smaller;">
									 	?
									</button>
									<textarea class="form-control" rows="3"></textarea>
								</div>
