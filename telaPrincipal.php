...
<!--Cabeçalho --> 
	...
	<div class="container">
		<section class="jumbotron">
			<h1 style="text-align: center; font-family: Verdana;"><b> Extensão </b> </h1>
			<br>
			<p style="text-align: justify; font-family: Verdana; ">&nbsp; &nbsp; &nbsp; O setor de Extensão do Campus Formiga está inserido na <a href="https://formiga.ifmg.edu.br/extensao-pesquisa-e-pos-graduacao/" target="_blank"> Secretaria de Extensão, Pesquisa e Pós-Graduação </a>(SEPPG) e é o órgão que tem por finalidade articular e apoiar a execução da política de extensão do Campus e do IFMG, seja através de ações específicas das áreas acadêmicas, seja através de ações institucionais, buscando uma integração mais efetiva da instituição com a realidade social na qual está inserida.
			<br><br>
			&nbsp; &nbsp; &nbsp;O setor de Extensão também trabalha com Relações Institucional sendo responsável pela gestão dos programas, projetos e cursos de extensão, além da prestação de serviços do Campus ao setor produtivo para a comunidade em geral. Uma de suas principais atribuições é o estabelecimento de convênios de cooperação técnico-científica, visando a elaboração de projetos, cursos e o intercâmbio de informações sobre novas tecnologias.
			<br><br>
			&nbsp; &nbsp; &nbsp;Nesta página o usuário irá encontrar informações sobre normas, manuais, formulários e links importantes relativos a este setor. Também estão disponibilizadas as normas que regem as atividades extensionistas no âmbito do Campus além de todos os formulários necessários para formalizar o registro de cursos e projetos de extensão.</p>
			<br>
			<div class="row"> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
				<div class="card mb-4 shadow-sm" style="width: 20rem;">
				  	<img class="card-img-top" src="./img/regulamentacao.PNG" alt="Card image cap">
				  	<div class="card-body">
				    	<center><h5 class="card-title">Regulamentação das Ações de Extensão</h5></center>
				    	<a href="https://formiga.ifmg.edu.br/documents/2018/Extensao/RegulamentaoAesdeExtenso_IN.pdf" target="_blank" class="btn btn-login" style="float: right; color: white">Vizualizar</a>
				  	</div>
				</div> &nbsp; &nbsp; 
				<div class="card mb-4 shadow-sm" style="width: 20rem;">
				  	<img class="card-img-top" src="./img/areasTematicas.PNG" alt="Card image cap">
				  	<div class="card-body">
				    	<center><h5 class="card-title">Áreas Temáticas das Ações de Extensão</h5></center>
				    	<a href="https://formiga.ifmg.edu.br/documents/2017/Extensao/reas-Temticas.pdf" class="btn btn-login" target="_blank" style="float: right; color: white">Vizualizar</a>
				  	</div>
				</div> &nbsp; &nbsp;
				<div class="card mb-4 shadow-sm" style="width: 20rem;">
				  	<img class="card-img-top" src="./img/linhasExtensao.PNG" alt="Card image cap">
				  	<div class="card-body">
				    	<center><h5 class="card-title">Linhas de Extensão</h5></center>
				    	<br>
				    	<a href="https://formiga.ifmg.edu.br/documents/2017/Extensao/Linhas-de-Extensao---novo.pdf" target="_blank" class="btn btn-login" style="float: right; color: white">Vizualizar</a>
				  	</div>
				</div>
			</div>
		</section>
