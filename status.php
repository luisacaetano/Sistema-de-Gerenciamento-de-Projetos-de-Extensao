...
<!--Cabeçalho --> 
	...
	<div class="container">
		<section class="jumbotron">
			<h1 style="text-align: center; font-family: Verdana;"><b> Status </b> </h1>
			<br>
			<div class="row"> 
				<?php
					...
					<form  class="col-md-4" method="post">
		            	<div class="card efeito-sombreamento">
			                ...
			                <div class="card-body">
			                    ...
			                    <div class="btn-group">
			                    <?php echo "<a class='btn btn-warning' style='background-color: #f19101; float: left;' href='apagarProjeto.php?id=".$row_extensao['CODEXTENSAO']."'>Cancelar Projeto</a>"; ?>
			                    </div>
			                    <small class="text-muted" style="float: right;"><br> Código: <?php echo $row_extensao['CODEXTENSAO'] ?> </small>
			                </div>
		                </div>
	            	</form>
	            <?php } ?>
