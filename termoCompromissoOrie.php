...
<!--Cabeçalho --> 
	...
	<div class="input-group bg-light pl-4 pt-3 pb-3" id="barraInformacaoTopo">
		<div>
			<div class="text-muted">
				<article>Termo de Compromisso do Orientador </article>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<section class="jumbotron">
			<h1 style="text-align: center; font-family: Verdana;"><b> Termo de Compromisso do Orientador</b> </h1>
			<br>
			<p style="text-align: justify; font-family: Verdana; ">&nbsp; &nbsp; &nbsp; Declaro que aceito orientar o aluno pesquisador/extensionista, de acordo com as normas fixadas pelo <a href="normas.php">Edital II 24/2018</a>, e com ascondições do presente termo, a saber:
			<br><br>
			<b>1. São obrigações do Pesquisador/Orientador: </b> <br><br>
			&nbsp;<b>a) </b> Propiciar ao aluno pesquisador/extesionista todos os recursos de materiais, equipamentos, preparo das instalações e demais condições necessárias para a execução da atividade e bom andamento do Plano de Trabalho.<br>
			...
			&nbsp;<b>d) </b> Comunicar à <a href="https://formiga.ifmg.edu.br/extensao-pesquisa-e-pos-graduacao/">Secretaria de Extensão, Pesquisa e Pós-Graduação</a>, por escrito, eventuais alterações no Plano de Trabalho, mudança de título do projeto e substituições de orientandos. <br>
			&nbsp;<b>e) </b> Cumprir, rigorosamente, os prazos estipulados pela Secretaria de Extensão, Pesquisa e Pós-Graduação. <br>
			&nbsp;<b>f) </b> O relatório final do projeto de pesquisa deverá atender os <b>objetivos</b> propostos no projeto original. <br>
			&nbsp;<b>g) </b> Cumprir rigorosamente os prazos estipulados pela Secretaria de Extensão, Pesquisa e Pós-Graduação. <br> <br>
			<b>3. O não cumprimento deste Termo impidirá a orientação em Programas de Iniciação Científica e Tecnológica e/ou de Extensão Tecnológica por parte do Orientador.</b> (Casos excepcionais serão analisados pela SEPPG). <br>
			</p>
			<a href="cadastroBolsista.php" type="submit" class="btn btn-lg btn-block btn-login" style="color: white;"> Aceitar e Continuar</a>
			<br><center><p>Ao clicar em Continuar, você concorda com os nossos <a href="termoCompromissoOrie.php">Termos de Compromisso</a>.</p> </center>
		</section>
	</div>
